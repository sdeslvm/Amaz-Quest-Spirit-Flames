...
class AmazQuestWebCoordinator: NSObject, WKNavigationDelegate, WKUIDelegate {
    private let callback: (AmazQuestWebStatus) -> Void
    private var didStart = false

    init(onStatus: @escaping (AmazQuestWebStatus) -> Void) {
