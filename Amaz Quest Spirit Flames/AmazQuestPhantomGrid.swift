...
protocol WebLoadable: AnyObject {
    var state: AmazQuestWebStatus { get set }
...
final class AmazQuestWebLoader: NSObject, ObservableObject, WebLoadable, ProgressMonitoring {
    // MARK: - Свойства

  @Published var state: AmazQuestWebStatus = .standby
    ...
    func observeProgression() {
        progressPublisher
            ...
            .sink { [weak self] progress in
                ...
                let newState: AmazQuestWebStatus = progress < 1.0 ? .progressing(progress: progress) : .finished
...
extension AmazQuestWebLoader: WKNavigationDelegate {
...
extension AmazQuestWebLoader {
    ...
    func publish(_ newState: AmazQuestWebStatus) {
...
private extension AmazQuestWebLoader {
    func updateState(_ newState: AmazQuestWebStatus) {
