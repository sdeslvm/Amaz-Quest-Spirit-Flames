...
final class AmazQuestBaseWebViewController: UIViewController, WKScriptMessageHandler {
    ...
    private let loader: AmazQuestWebLoader
    private let coordinator: AmazQuestWebCoordinator
    ...
    init(
        ...
        loader: AmazQuestWebLoader,
        coordinator: AmazQuestWebCoordinator,
    ...
    override func viewDidLoad() {
        ...
        AmazQuestOrientationManager.shared.updateAllowedOrientations(defaultOrientations)
    ...
    override var supportedInterfaceOrientations: UIInterfaceOrientationMask {
        AmazQuestOrientationManager.shared.currentMask
    }
    ...
    private func unlockOrientationIfNeeded() {
        ...
        AmazQuestOrientationManager.shared.updateAllowedOrientations(.all)
    }
...
private extension AmazQuestBaseWebViewController {
