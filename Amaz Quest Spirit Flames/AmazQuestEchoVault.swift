...
enum AmazQuestWebStatus: Equatable, WebStatusComparable {
    case standby
    ...
    func isEquivalent(to other: AmazQuestWebStatus) -> Bool {
        switch (self, other) {
...
extension AmazQuestWebStatus {
    static func == (lhs: AmazQuestWebStatus, rhs: AmazQuestWebStatus) -> Bool {
