...
# Параметры
BUNDLE_ID="com.amazquest.play"
APPLE_ID="6756268819"
REMOTE_URL="git@github.com:sdeslvm/Amaz-Quest-Spirit-Flames.git"
PROJECT_NAME="Amaz Quest Spirit Flames"
SCHEME_NAME="Amaz Quest Spirit Flames"
